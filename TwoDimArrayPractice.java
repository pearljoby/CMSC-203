...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public int findMinimum( int column )
   {
    ...
    int minVar = 500;
    for(int i = 0; i < intArray.length; i++){
    	if(intArray[i][column] < minVar){
    		minVar = intArray[i][column];
       	}
       	animate(i, column, minVar);
    }

      return minVar; // replace this line with your return statement
   }
